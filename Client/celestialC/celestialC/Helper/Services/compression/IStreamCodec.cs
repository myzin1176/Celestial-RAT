...
namespace celestialC.Helper.Services.compression
{
    public interface IStreamCodec : IDisposable, IModifiedDecoder
    {
        ...
        RemoteDesktopDataInfo CodeImage(IntPtr scan0, Rectangle[] updatedAreas, DesktopDuplication.MovedRegion[] movedRegions, Size imageSize, PixelFormat pixelFormat);
    }
